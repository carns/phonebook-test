...
typedef YP_return_t (*YP_backend_create_fn)(margo_instance_id, YP_provider_t, const char*, void**);
typedef YP_return_t (*YP_backend_open_fn)(margo_instance_id,YP_provider_t, const char*, void**);
